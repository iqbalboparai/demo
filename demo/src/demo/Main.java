...
public class Main {
    ...
    static String s = "Frank->Mary,Mary->Sam,Mary->Bob,Sam->Katie,Sam->Pete,Bob->John,Sam->Bob,Bob,Katie" ;
    ...
    static Map<String,String> createDict(String[] items){
        ...
        for ( int i = 0 ; i < items.length - 2 ; i++ ){
            ...
            if(m.containsKey(pair[1])){
            	System.out.println(pair[1] + " already has a manager:" + m.get(pair[1]));
            	System.out.println("Cannot add " + pair[0] + " as a second manager");
            	System.exit(0);
            }else{
            m.put( pair[1], pair[0] );
            }
